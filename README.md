...
- Which -b options you can use, here's a recommendation: for blue/green themes use the default one: #1c1b26. For the amber/ember you can use: #1d1b1b which is similar of Ash-grey, while the first one is like gray-blueish
